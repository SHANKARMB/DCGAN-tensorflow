...
def main(pm, pv, qm, qv, func='kl'):
    if func == 'js':
        return gau_js(pm, pv, qm, qv)
    elif func == 'bh':
        return gau_bh(pm, pv, qm, qv)
    else:
        return gau_kl(pm, pv, qm, qv)
...
if __name__ == '__main__':
    m1, v1 = [1.300333], [math.pow(0.3111471, 2)]
    m2, v2 = [1.0186082], [math.pow(0.017949143, 2)]  # 1.0186082 0.017949143
    print('real.. mean and variance ', m1[0], ' , ', v1[0])
    print('gau_kl for same ', gau_kl(numpy.array(m1), numpy.array(v1), numpy.array(m1), numpy.array(v1)))
    print('gau_bh for same ', gau_bh(numpy.array(m1), numpy.array(v1), numpy.array(m1), numpy.array(v1)))
    print('gau_js for same ', gau_js(numpy.array(m1), numpy.array(v1), numpy.array(m1), numpy.array(v1)))

    print('real.. mean and variance ', m1[0], ' , ', v1[0])
    print('gen.. mean and variance ', m2[0], ' , ', v2[0])
    print('gau_kl ', gau_kl(numpy.array(m1), numpy.array(v1), numpy.array(m2), numpy.array(v2)))
    print('gau_bh ', gau_bh(numpy.array(m1), numpy.array(v1), numpy.array(m2), numpy.array(v2)))
    print('gau_js ', gau_js(numpy.array(m1), numpy.array(v1), numpy.array(m2), numpy.array(v2)))
    # 1.0222794 0.020045605
    m2, v2 = [1.0222794], [math.pow(0.020045605, 2)]  # 1.0222794 0.020045605
    print('real.. mean and variance ', m1[0], ' , ', v1[0])
    print('gen.. mean and variance ', m2[0], ' , ', v2[0])
    print('gau_kl ', gau_kl(numpy.array(m1), numpy.array(v1), numpy.array(m2), numpy.array(v2)))
    print('gau_bh ', gau_bh(numpy.array(m1), numpy.array(v1), numpy.array(m2), numpy.array(v2)))
